...
namespace AspNetCore.Identity.PG.Context
{
    public class PostgreSQLDatabase
    {
        ...
        private static readonly object _consulta = new object();
        ...
        public PostgreSQLDatabase(IConfiguration configurationRoot)
        {
            ...
            try
            {
                _connection = new NpgsqlConnection(_configurationRoot.GetConnectionString(IdentityDbConfig.StringConnectionName));
            }
            catch (Exception)
            {
