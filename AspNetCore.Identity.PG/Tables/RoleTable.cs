...
namespace AspNetCore.Identity.PG.Tables
{
    ...
    public class RoleTable<TRole> where TRole : IdentityRole
    {
        ...
        {
            string commandText = "DELETE FROM " + fullTableName + " WHERE " + fieldId.Quote() + " = @id";
        ...
        {
            string commandText = "INSERT INTO " + fullTableName + " (" + fieldId.Quote() + ", " + fieldName.Quote() + ") VALUES (@id, @name)";
            Dictionary<string, object> parameters = new Dictionary<string, object>
            {
                { "@name", role.Name },
                { "@id", role.Id }
        ...
        {
            string commandText = "SELECT " + fieldName.Quote() + " FROM " + fullTableName + " WHERE " + fieldId.Quote() + " = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@id", roleId);
        ...
        {
            string roleId = null;
            string commandText = "SELECT " + fieldId.Quote() + " FROM " + fullTableName + " WHERE lower(" + fieldName.Quote() + ") = @name";
        ...
        {
            string commandText = "UPDATE " + fullTableName + " SET " + fieldName.Quote() + " = @name WHERE " + fieldId.Quote() + " = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
